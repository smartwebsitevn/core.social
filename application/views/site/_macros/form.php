 ...
 * Form row
 */
$this->register('row_', function(array $row){ ob_start(); ?>
 ...
 * Form captcha
 */
$this->register('captcha', function($args = []){ ob_start(); ?>
		...
		<div class="col-sm-<?php echo $input_col ?>">
			...
			<div class="input-group form-captcha">
				...
				<span class="input-group-addon" style="padding:3px 12px">
					...
					<img id="<?php echo $_id; ?>" src="<?php echo $url; ?>" _captcha="<?php echo $url; ?>" class="captcha">
	...
	<div class="form-group form-group-index <?php echo $class ?>" <?php echo t('html')->attr($attr) ?> >
		...
		<?php elseif ($type == 'select' || $type == 'select_multi'):
			...
			?>>
				...
				<?php if ($type == 'select'): ?>
					<ul class="dropdown-menu limit-height">
						<?php if ($values): ?>
							<?php foreach ($values as $v => $n): ?>
				...
				<?php else: ?>
					<div class="dropdown-menu dropdown-2colums clearfix">
						<div class="dropdown-menu dropdown-menu-left limit-height">
							<div class="form-group">
		...
		<?php if($can_hide):
			...
			<a style="width: 50px;margin-left:10px " data-param="<?php echo $hide_target ?>"  class="removes hide_target " title="X�a">
...
$this->register('info_job', function (array $input) {
	...
	<div class="form-group form-group-index">
		...
		<div class="dropdown search-dropdown">
			...
			<ul class="dropdown-menu limit-height noparentjob">
...
$this->register('info_country_multi', function (array $input) {
	...
	<div class="form-group form-group-index">
		...
		<!-- <div class="checkbox">
             <label>
                 <input type="checkbox" value="1" name="contact_email_is_public"><span>N??c Ngo�i</span>
             </label>
         </div>-->
		<div class="dropdown search-dropdown">
			<div class="dropdown-toggle" aria-expanded="true" aria-haspopup="true" data-toggle="dropdown" type="button">
...
$this->register('info_city', function (array $input) {
	...
	<div class="form-group form-group-index">
		...
		<!--<div class="checkbox">
            <label>
                <input type="checkbox" value="1" name="contact_email_is_public"><span>Vi?t Nam</span>
            </label>
        </div>-->
		<div class="dropdown search-dropdown">
			<div class="dropdown-toggle" aria-expanded="true" aria-haspopup="true" data-toggle="dropdown" type="button">
	...
	<div class="form-group form-group-index">
		...
		<div class="dropdown search-dropdown">
			...
			<div class="dropdown-menu dropdown-2colums clearfix">
				...
				<div class="dropdown-menu dropdown-menu-right limit-height">
			...
			<div class="table-ky-nang">
				<div class="form-group has-feedback select-search-feedback">
					...
					<div class="select-container select-container-dropdown">
						<ul class="select-results limit-height">
							<?php
