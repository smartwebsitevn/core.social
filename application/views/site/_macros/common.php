 ...
 * Page title
 */
$this->register('page_heading', function ($title, $attr = array(), $args = array()) {
    ob_start();
...
->register('page_body_start', function(array $attr = array()){
    ob_start();
...
$this->register('page_body_end', function () {
    ob_start(); ?>
 ...
 * Hien thi thong tin
 */
$this->register('info', function (array $list) {
    ob_start(); ?>
 ...
 * Status
 */
$this->register('status_color', function ($status, $label = null) {
    ob_start(); ?>
