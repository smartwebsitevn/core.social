<?php echo macro()->page_heading(lang('message_send')) ?>
<?php echo macro()->page_body_start() ?>
<?php view('tpl::message/_menu', ['current' => 'send']); ?>
    <form class="form_action form_action" action="<?php echo current_url() ?>" method="post">

        <div class="form-item webform-component-ten-nguoi-dung">
            <label class="element-invisible" for="param_username"><?php echo lang('username'); ?>:</label>
        ...
        <div class="form-item webform-component-ten-nguoi-dung">
            <label class="element-invisible" for="param_title"><?php echo lang('title'); ?>:<span
        ...
        <div class="form-item webform-component-ten-nguoi-dung">
            <label class="element-invisible" for="param_content"><?php echo lang('content'); ?>:<span
                    class="req">*</span></label>
        ...
        <div class="form-item webform-component-ten-nguoi-dung">
            <label class="element-invisible" for="param_pin"><?php echo lang('pin'); ?>:<span
                    class="req">*</span></label>
