        ...
        <?php  foreach ($list as $row) :           ?>
            <div class="ratings-and-reviews__review-container">
                ...
                <div class="ratings-and-reviews__review-comment-container">
                    <div class="star-rating--static star-rating--small"><span style="width: <?php echo 18 * ($row->rate ) ?>px;"></span></div>
                    <div class="ratings-and-reviews__review-created" translate=""><span><?php echo date('H', $row->created) ?> h<?php echo date('i', $row->created) ?></span></div>
