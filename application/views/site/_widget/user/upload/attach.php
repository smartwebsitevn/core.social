...
<div class="upload_<?php echo $_rd; ?> uploadprofile">
	...
	<div class="upload_action link1">
		<a target="_blank" class="up-ho-so" data-title="Không có hồ sơ đính kèm" data-profile="Xem file đính kèm">
			<span>Hồ Sơ Đính Kèm</span><br>
			<small id="action_upload" class="btnupload" data-title="Attach File" data-profile="Update File"
			   title="<?php echo $this->lang->line('max_size'); ?>: <?php echo $upload_config['max_size']/1024; ?>Mb - <?php echo $this->lang->line('allowed_types'); ?>: <?php echo str_replace('|', ', ', $upload_config['allowed_types']); ?>">Attach File</small>
		</a>
		<a href='#' id="action_del" class="removefile" title="Xóa file"></a>
<!--		<a href="" >--><?php //echo $this->lang->line('browse_file'); ?><!--</a> |-->
<!--		<a href="" >--><?php //echo $this->lang->line('del_file'); ?><!--</a>-->
