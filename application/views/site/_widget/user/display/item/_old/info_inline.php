        ...
        <div class="container-fluid">
            <div class="item" style="background-image: url(<?php echo $row->banner->url ?>)">
                ...
                <div class="box-content">
                    <div class="mb10">
                        <a class="user-item-name" href="<?php echo $row->_url_view ?>"><?php echo $row->name ?></a>
                    <?php if(isset($row->name_en) && $row->name_en): ?>
                        <a class="user-item-name-en" href="<?php echo $row->_url_view ?>"><?php echo $row->name_en ?></a>
                    <?php endif; ?>
                    </div>
                    <a href="<?php echo $row->_url_view ?>" class="user-play"></a>
