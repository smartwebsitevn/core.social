...
<?php //foreach (array('_training_name', '_school_name', '_subject_name') as $f) : ?>
    <?php if (isset($row->_training_name)): ?>
        <br>
        <span>Hệ: <?php echo $row->_training_name ?></span>
    <?php endif; ?>
    <?php if (isset($row->_school_name)): ?> ,
        <span>Trường: <?php echo $row->_school_name ?></span>
    <?php endif; ?>
    <?php if (isset($row->_subject_name)): ?> ,
        <span>Bộ môn: <?php echo $row->_subject_name ?></span>
    <?php endif; ?>
<?php //endforeach; ?>
