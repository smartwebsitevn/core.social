...
<form id="form_filter_advance" name="form_filter_advance" action="<?php echo $action; ?>" method="get">
    ...
    <div class="widget widget-filter">
        ...
        <?php echo $_data_cat_type($cat_type_time_blog_author, 'time_blog_author_id'); ?>
    </div>
    <div class="widget widget-filter">
    ...
    <div class="widget widget-tag">
        ...
        <?php foreach ($tags as $row): ?>
            ...
            <a href="<?php echo site_url('blog_author_list/tag/' . $row->seo_url) ?>"><?php echo $row->name ?></a>
        <?php endforeach; ?>
    </div>
</form>
    ...
    $(document).ready(function () {
        ...
        $("#product-category .pagging-ajax a").bind("click", function () {
            ...
            if (page != undefined) {
                ...
                if (page == '')   page = 0;
                //alert(page);
                blog_authorFilter(page);
            }
            return false;
        });

    });
    function blog_authorFilter(page) {
        //alert(page);
