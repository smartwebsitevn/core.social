                ...
                <div class="item-info">
                    ...
                    <div class="item-detail">
                        ...
                        <div class="item-info-price">
                            <?php echo view('tpl::_widget/user_notice/display/item/info_price', array('info' => $row)); ?>
                            <?php echo view('tpl::_widget/user_notice/display/item/info_rate', array('info' => $row)); ?>
                        </div>
                    </div>
                </div>
            </li>
