<?php if (isset($list) && $list): ?>
        ...
        <div class="item-kh">
            <div class="item-info">
                <div class="item-photo">
                    ...
                    <?php echo view('tpl::_widget/aboutus/display/item/info_label', array('info' => $row)); ?>
                    <?php //echo view('tpl::_widget/aboutus/display/item/info_author', array('info' => $row)); ?>
                    <?php //echo view('tpl::_widget/aboutus/display/item/info_stats', array('info' => $row)); ?>
                </div>
    ...
    <?php if (t('input')->is_ajax_request() && isset($pages_config)) : ?>
        <?php widget('aboutus')->display_pagination($pages_config); ?>
    <?php endif; ?>
