<?php if ($can_do): ?>
    <a  href="#0" title='' class="btn btn-outline btn-sm  do_action <?php if ($favorited) echo 'on'; ?>"
        data-action="toggle"
   ...
   <?php else: ?>
    <a class="btn btn-outline btn-sm act-notify-modal" title='<?php echo lang("action_favorite") ?>' href="javascript:void(0)"
