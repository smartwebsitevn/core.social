<?php if ($can_do): ?>
    <a  href="#0" title='' class="btn btn-outline  do_action <?php if ($favorited) echo 'on'; ?>"
        data-action="toggle"
   ...
   <?php else: ?>
    <a class="btn btn-outline act-notify-modal" title='<?php echo lang("action_favorite") ?>' href="javascript:void(0)"
