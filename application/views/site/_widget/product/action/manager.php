<?php if ($user): // pr($user); ?>
        <form class="form_action"  action="<?php echo $url_set_point; ?>" method="post">
            <?php //form_csrf(); ?>
            <div class="pull-left">
            (Point thực: <?php echo $info->point_real ?>) <input type="text" name="set_point" value="<?php //echo $info->point_fake ?>" class="form-control input-sm" >
            ...
            <div class="checkbox pull-right">
                ...
                <label title="Mới nổi">
                    <?php $is_feature =$info->is_feature?1:0 ?>
                    <input  value="1" type="checkbox" <?php echo form_set_checkbox(1,$is_feature) ?>>
                    <span>&nbsp;</span>
                </label>
                <span >Mới nổi</span>
                </a>
