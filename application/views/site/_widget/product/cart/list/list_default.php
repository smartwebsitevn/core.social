    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th width="11%"><?php echo lang('quantity') ?></th>
            ...
            if ($count == 0) {
                ...
                foreach ($list as $row) {
                    ...
                    <tr>
                        <td class="img">
                            <a href="<?php echo $row->url_view ?>"><img width="50" height="50" title="" alt=""
                                                                        src="<?php echo $row->thumb ?>"></a>
                        </td>
                        <td class="name">
                        ...
                        <td class="price" style="text-align: right">
                            <?php echo currency_format_amount($row->price) ?>
                        </td>
