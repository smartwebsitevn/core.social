            ...
            <div class="item-social <?php echo isset($row->_ads) ? 'item-social-ads' : '' ?> ">
                <div class="clearfix">
                    ...
                    <div class="item-info">
                        ...
                        <div class="item-meta">
                            <span>
                            <a class="do_action" data-type="" data-url="<?php echo site_url('product/vote/'.$row->id)."?act=like" ?>"><i class="pe-7s-angle-up-circle" ></i></a>
                            <a class="do_action" data-type="" data-url="<?php echo site_url('product/vote/'.$row->id)."?act=dislike" ?>"><i class="pe-7s-angle-down-circle" ></i></a>
                            </span>
                                <span
                        ...
                        <div class="item-action">
                            ...
                            <?php // widget('product')->action_follow($row,$user) ?>
                            <?php //widget('product')->action_favorite($row,$user) ?>
                    ...
                    <div class="item-media">
                        <?php if ($row->video):
                            ...
                            <iframe width="100%" height="300px"  src="https://www.youtube.com/embed/<?php echo $link ?>?rel=0" frameborder="0" allowfullscreen></iframe>
                        <?php else: ?>
                            <?php $row = mod('product')->add_info_images($row) ?>
