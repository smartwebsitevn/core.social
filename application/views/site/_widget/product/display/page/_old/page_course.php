...
<div class="fxw db-xs pos-r c_discovery-units__header infinite-scroll ">
    ...
    <div class="nav-container">
        <div class="product-nav-btn product-nav-btn1 prev btn btn-default">

        </div>
        <div class="product-nav-btn product-nav-btn1 next btn btn-default">

        </div>
    </div>
</div>
<div class="discover-products-list-mask">
    <?php //pr($list);
    if (isset($list) && $list): ?>
