...
$_macro['toolbar_sub'] = array(
	array('url' => admin_url('type_item'), 'title' => lang('mod_type_item')),
	array('url' => admin_url('type'), 'title' => lang('mod_type'),'attr'=>array('class'=>'active')),
	...
	<div class="portlet">
		<div class="portlet-heading dark">
			<div class="portlet-title">
				<h4><i class="fa fa-pencil"></i> <?php echo lang('mod_type'); ?></h4>
			</div>
			...
			<form class="form form-horizontal" id="form" method="post" action="<?php echo $action; ?>">
				<div class="tc-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_general"><?php t('view')->load('tpl::type/form/general'); ?></div>
						<div class="tab-pane" id="tab_detail"><?php t('view')->load('tpl::type/form/detail'); ?></div>
                           <?php /*?>
                         <div class="tab-pane" id="tab_advance"><?php t('view')->load('tpl::type/form/advance'); ?></div>
                           <?php */?>    
