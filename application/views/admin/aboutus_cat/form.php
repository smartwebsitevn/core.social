...
$_macro['toolbar_sub'] = array(
    array('url' => admin_url('aboutus'), 'title' => lang('mod_aboutus')),
    array('url' => admin_url('aboutus_cat'), 'title' => lang('mod_aboutus_cat'),'attr'=>array('class'=>'active') )
);
	...
	<div class="portlet">
		<div class="portlet-heading bg-primary">
			<div class="portlet-title">
				<h4><i class="fa fa-pencil"></i> <?php echo lang('mod_aboutus_cat'); ?></h4>
			</div>
			...
			<form class="form form-horizontal" id="form" method="post" action="<?php echo $action; ?>">
				<div class="tc-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_general"><?php t('view')->load('tpl::aboutus_cat/form/general'); ?></div>
						<div class="tab-pane" id="tab_detail"><?php t('view')->load('tpl::aboutus_cat/form/detail'); ?></div>
...
<?php t('view')->load('tpl::aboutus_cat/_js') ?>