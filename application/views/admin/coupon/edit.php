		...
		<fieldset>
			<div class="widget">
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo req"><strong><?php echo $info->code?></strong></span>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="number_user" id="param_number_user"  _autocheck="true" type="text" value="<?php echo $info->number_user?>"/></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="expire" id="param_expire"  type="text" class="datepicker" value="<?php echo $info->expire?>"/></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
						    <input type="radio" name="status" value="0" id="status_0" <?php echo form_set_checkbox($info->status, '0'); ?>/>
							<label for="status_0"><?php echo lang('no');?></label>
							
							<input type="radio" name="status" value="1" id="status_1" <?php echo form_set_checkbox($info->status, '1'); ?>/>
