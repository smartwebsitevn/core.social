		...
		<fieldset>
			<div class="widget">
				<div class="title">
					...
					<h6><?php echo lang('edit'); ?> <?php echo lang('mod_cat_news'); ?></h6>
				</div>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<label>
							<input type="radio" name="status" value="0" <?php echo form_set_checkbox((int)$info->status, 0); ?> />
							<?php echo lang('off');?>
						</label>
						
						<label>
							<input type="radio" name="status" value="1" <?php echo form_set_checkbox((int)$info->status, 1); ?> />
							<?php echo lang('on');?>
						</label>
					</div>
					<div class="clear"></div>
