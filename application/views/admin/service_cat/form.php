	...
	<div class="portlet">
		<div class="portlet-heading bg-primary">
			<div class="portlet-title">
				<h4><i class="fa fa-pencil"></i> <?php echo lang('mod_service_cat'); ?></h4>
			</div>
			...
			<form class="form form-horizontal" id="form" method="post" action="<?php echo $action; ?>">
				<div class="tc-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_general"><?php t('view')->load('tpl::service_cat/form/general'); ?></div>
						<div class="tab-pane" id="tab_detail"><?php t('view')->load('tpl::service_cat/form/detail'); ?></div>
...
<?php t('view')->load('tpl::service_cat/_js') ?>