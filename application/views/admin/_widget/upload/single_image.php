...
<div class="upload_<?php echo $_rd; ?> left">
	...
	<div class="upload_action link1" style="margin-top:2px;">
		...
		<span id="span_action_modify" style="display:none"><a href="" onclick="call_image_croper(this); return false;" id="action_modify"><?php echo $this->lang->line('modify_file'); ?></a></span>
		...
		<div id="upload_complete">
			<div class="file_image_single">
				<div class="file_image_single_img">
					<a href="{file_url}" onclick="lightbox(this); return false;"><img></a>
				</div>
			</div>
		</div>
