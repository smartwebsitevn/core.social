...
<form class="form" id="main_popup" action="<?php echo $action; ?>" method="post">
	<div class="widget mg0" style="width:500px; height:350px;">
		<div class="title">
			...
			<h6><?php echo lang('edit'); ?> <?php echo lang('mod_cat'); ?></h6>
		</div>
		
		<div class="formRow">
			<label class="formLeft" for="param_name"><?php echo lang('name'); ?>:<span class="req">*</span></label>
			<div class="formRight">
				<input name="name" value="<?php echo $info->name; ?>" id="param_name" _autocheck="true" class="left" style="width:250px;" type="text" />
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input name="sort_order" value="<?php echo $info->sort_order; ?>" id="param_sort_order" _autocheck="true" class="left" style="width:100px;" type="text" />
