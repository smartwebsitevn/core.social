...
/*$_macro['toolbar_sub'] = array(
    array('url' => admin_url('manufacture'), 'title' => lang('mod_manufacture'),'attr'=>array('class'=>'active')),
    array('url' => admin_url('manufacture_link'), 'title' => lang('mod_manufacture_link'), )
);*/
	...
	<div class="portlet">
		<div class="portlet-heading bg-primary">
			<div class="portlet-title">
				<h4><i class="fa fa-pencil"></i> <?php echo lang('mod_manufacture'); ?></h4>
			</div>
			...
			<form class="form form-horizontal" id="form" method="post" action="<?php echo $action; ?>">
				<div class="tc-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_general"><?php t('view')->load('tpl::manufacture/form/general'); ?></div>
						<div class="tab-pane" id="tab_detail"><?php t('view')->load('tpl::manufacture/form/detail'); ?></div>
...
<?php t('view')->load('tpl::manufacture/_js') ?>