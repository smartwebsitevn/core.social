...
$_macro['toolbar_sub'] = array(
    array('url' => admin_url('service'), 'title' => lang('mod_service'),'attr'=>array('class'=>'active')),
    array('url' => admin_url('service_cat'), 'title' => lang('mod_service_cat'), )
);
	...
	<div class="portlet">
		<div class="portlet-heading bg-primary">
			<div class="portlet-title">
				<h4><i class="fa fa-pencil"></i> <?php echo lang('mod_service'); ?></h4>
			</div>
			...
			<form class="form form-horizontal" id="form" method="post" action="<?php echo $action; ?>">
				<div class="tc-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_general"><?php t('view')->load('tpl::service/form/general'); ?></div>
						<div class="tab-pane" id="tab_detail"><?php t('view')->load('tpl::service/form/detail'); ?></div>
						<?php /*?>
                         <div class="tab-pane" id="tab_advance"><?php t('view')->load('tpl::service/form/advance'); ?></div>
 						<?php */?>
...
<?php t('view')->load('tpl::service/_js') ?>