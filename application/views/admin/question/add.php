		...
		<fieldset>
			<div class="widget">
				<div class="title">
					...
					<h6><?php echo lang('add'); ?> <?php echo lang('mod_question'); ?></h6>
				</div>
				...
				<div class="formRow">
					...
					<div class="clear"></div>
					<div class="formRight">
						<div class="editor_border"><textarea name="content" id="param_content" class="editor" style="height:200px;"  ></textarea></div>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneFour"><input name="sort_order" id="sort_order" class="sort_order" _autocheck="true" type="text" /></span>
