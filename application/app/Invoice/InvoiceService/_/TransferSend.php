...
class TransferSend extends InvoiceService
{
	/**
	 * Khoi tao doi tuong
	 */
	...
	{
		return ServiceType::TRANSFER_SEND;
	}
	...
	public function getOrderDesc(InvoiceOrderModel $invoice_order)
	{
		...
		return lang('order_desc_transfer_send', [
	...
	{
		$transfer = TransferModel::findBySendInvoiceOrder($invoice_order->id);

		if ( ! $transfer) return;

		$data = compact('transfer');

		return view('tpl::transfer/view/send', $data, true);
	}
