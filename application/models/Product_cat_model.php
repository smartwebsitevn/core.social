...
class Product_cat_model extends Core_hiarachy_model
{
    ...
    public $fields = array(
        ...
        //== Info main
        'name', 'parent_id', 'video', 'brief', 'description', 'tags',
    ...
    public $fields_type_image = array(/*'avatar',*/
        'image', 'banner', 'icon');
        ...
        if (@$children[$id] && $level <= $maxlevel) {
            ...
            foreach ($children[$id] as $t) {
                ...
                if (count(@$children[$id]) > 0)// neu khac null ->co con
                {
                    ...
                    $datanode =
                        '<a href="Javascript:;"  ' . $bg . ' class="level' . $level . $active . $class_bg . '">
                ...
                if (count(@$children[$id]) > 0)// neu khac null ->co con
                {
                    ...
                    $datanode =
						...
						<a href="Javascript:;"  class=" level' . $level . $active . '">
						    <span class="link_icon udi udi-development"></span> ' . $t->$fieldtitle . '
					</a>';
                    /*if($parent_islink)
                    {
                        $datanode='<a href="'.$linkCategory.'" class="level'.$level.$active.'" ><span>'.$t->$fieldtitle.'</span></a>';
					...
					<a href="' . $linkCategory . '"  class="level' . $level . $active . '" >
					   <b class="menu_icon udi udi-web-development"></b>
