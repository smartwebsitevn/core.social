...
class Manufacture extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        /*$this->data['categories'] = mod('product_cat')->category_tree(
            model('product_cat')->get_list()
        );*/
    ...
    function _check_cat($value)
    {
        ...
        $cat = model("product_cat")->get_info($value, 'id');
        if ( ! $cat)
        {
