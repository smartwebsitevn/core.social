...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = false, $error_messages = null) {
        ...
        $this->options = array(
           // 'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'script_url' => admin_url('file_adv/upload'),
            'upload_dir' =>$config['folder'] . '/' . $folder .'/',
            'upload_url' => $this->get_full_url().$config['folder'] . '/' . $folder .'/',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    'upload_dir' =>$config['folder'] . '/' . $folder .'/',
                    'upload_url' => $this->get_full_url() . '/'.$config['folder'] . '/' . $folder .'_thumb/',
    ...
    public  function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        //$name= file_create_new_name($name);
        return $name;
    }
    ...
    public  function basename($filepath, $suffix = null) {
