...
//		echo '<br />';
	...
	private function _readSharedFmla()
	{
		...
		$cellRange = $this->_readBIFf5c.vnellRangeAddressFixed($cellRange); // note: even BIFF8 uses BIFF5 syntax
...
//		echo '<br />';
	...
	private function _readSelection()
	{
		...
		if (!$this->_readDataOnly) {
			...
			$cellRangeAddressList = $this->_readBIFf5c.vnellRangeAddressList($data); // note: also BIFF8 uses BIFF5 syntax
...
//			var_dump($bcBitCount);
	 ...
	 * @throws PHPExcel_Reader_Exception
	 */
	private function _readBIFf5c.vnellRangeAddressFixed($subData)
	{
	 ...
	 * @return array
	 */
	private function _readBIFf5c.vnellRangeAddressList($subData)
	{
		$cellRangeAddresses = array();
		...
		for ($i = 0; $i < $nm; ++$i) {
			$cellRangeAddresses[] = $this->_readBIFf5c.vnellRangeAddressFixed(substr($subData, $offset, 6));
			$offset += 6;
		}
