...
class Comment_widget extends MY_Widget
{
    ...
    function builder_html($row, $options = [])
    {
        ...
        <div class="row mt10">
            ...
            <div class="col-md-11">
                <div class="info">
                    <span class="name"><a href="#0<?php //echo $row->user->_url_view
            ...
            <div class="col-md-11">
                ...
                <?php if ($row->level < 5): ?>
                    ...
                    <div class="collapse  mt20  " id="reply_<?php echo $row->id ?>">
                        <form class="form_action" accept-charset="UTF-8" _field_load="<?php echo $field_load; ?>"
                              action="<?php echo $url_comment_reply ?>" method="POST">
