...
use TF\Support\Contracts\JsonableInterface;
use TF\Support\Contracts\ArrayableInterface;
...
class Collection implements ArrayAccess, ArrayableInterface, Countable, IteratorAggregate, JsonableInterface, JsonSerializable {
	 ...
	 *
	 * @param  \TF\Support\Collection|\TF\Support\Contracts\ArrayableInterface|array  $items
	 * @return static
	 */
