<?php namespace TF\Translation;

use TF\Support\Collection;
use TF\Support\NamespacedItemResolver;
...
class Translator extends NamespacedItemResolver implements TranslatorInterface {
	 ...
	 *
	 * @var \TF\Translation\LoaderInterface
	 */
	protected $loader;
	...
	/**
	 * Array of opening and closing tags for replace.
	 *
	 * @var array
	 */
	protected $replaceTags = array(array('{', '}'));
	
	/**
	 * Create a new translator instance.
	 *
	 * @param  \TF\Translation\LoaderInterface  $loader
	 * @param  string  $locale
	 * @return void
	 */
	...
	protected function parseLocale($locale)
	{
		...
		return array_unique(array_filter(array($locale, $this->fallback)));
	}
	 ...
	 *
	 * @return \TF\Translation\LoaderInterface
	 */
	...
	/**
	 * Get the replace tags being used.
	 *
	 * @return array
	 */
	...
	/**
	 * Set the replace tags
	 * 
	 * @param array $replaceTags
	 * @return void
	 */
	public function setReplaceTags(array $replaceTags)
	{
