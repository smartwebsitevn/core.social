(function($)
{
	...
	{
		var g_setting_default = {mod:'', plugin_path:'', url_upload:'', url_get:'', url_update:'', config_extensions:'', config_max_size:'', auto_upload:true};
		...
		return $(this).each(function()
		{
			...
			switch (g_setting.mod)
			{
				...
				case 'company_image':
				case 'company_post_images':
				case 'company_post_files':
				case 'profile':
				case 'single':
				case 'single_image':
				{
					...
					$(this).nstUI({
						...
						loadAjax:{
							...
							event_complete: function(data)
							{
								...
								else if  (g_setting.mod == 'profile')
								{
									if (data.id && data.id > 0)
									{
										$('.block-avatar .up-ho-so').addClass('hasprofile');
										$('.block-avatar .up-ho-so').attr('title', $('.block-avatar .up-ho-so').data('profile'));
										$('.block-avatar .up-ho-so').attr('href', data._url);
										$('.block-avatar .up-ho-so .btnupload').text($('.block-avatar .up-ho-so .btnupload').data('profile'));
										$('.block-avatar .upload_action .removefile').attr('href', data._url_del).show();
									}else {
										$('.block-avatar .up-ho-so').removeClass('hasprofile');
										$('.block-avatar .up-ho-so').attr('title', $('.block-avatar .up-ho-so').data('title'));
										$('.block-avatar .up-ho-so').removeAttr('href');
										$('.block-avatar .up-ho-so .btnupload').text($('.block-avatar .up-ho-so .btnupload').data('title'));
										$('.block-avatar .upload_action .removefile').attr('href', '#').hide();
									}
								}
